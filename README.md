...
- Legacy Architects V2: Architected and developed a serverless estate planning SaaS platform enabling secure attorney-client collaboration using AWS SAM, Lambda, and PostgreSQL microservices. (https://legacysystem.com) Tech Stack: AWS SAM, Lambda, EC2, S3, PostgreSQL, Sequelize, Node.js, SendGrid, Clerk, Docker, Sentry error tracking, AWS CDK, AWS Serverless Application Model (AWS SAM), AWS Amplify, Microservices, Lambda, S3, Docker, Sendgrid, Clerk, Postgres, ReactJS, Javascript, HTML, CSS
- Ez-wins: SaaS software Full-Stack Developer (https://www.ez-wins.net). Tech Stack: Laravel 12, ReactJS, Typescript, OpenAI API, HTML, CSS, MySQL, AWS, Serverless, Lambda, Cloudwatch, Eventbridge, S3, EC2, Docker, AWS devops,
- Advenits: Full-stack Developer (https://www.adventiscg.com), Tech Stack: Laravel, Vue.Js, CSS, HTML, JavaScript, JQuery, Meilisearch, MySQL, AWS, S3, EC2, AWS devops
- MobiliHD: Design and development of API for MobiliHD (https://www.financar.com.co). Tech Stack: Laravel, Mysql, AWS, S3, EC2
